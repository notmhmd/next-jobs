  ...
  return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-6">
        ...
        <motion.p
            ...
            className="text-lg text-gray-300 mt-3 text-center"
        >
        ...
        >
          <Button
              className="px-6 py-3 text-lg bg-blue-500 hover:bg-blue-600"
              onClick={() => router.push("/register")}
          >
            Register as Candidate
          </Button>
          <Button
              className="px-6 py-3 text-lg bg-gray-700 hover:bg-gray-800"
